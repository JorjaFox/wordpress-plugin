...
/**
 * FLF_Jetpack_Feedback class.
 * Functions used by Jetpack
 */
class FLF_Jetpack_Feedback {
	...
	public function jetpack_harassment( $is_spam, $form ) {
		...
		$badlist    = array();
		$disallowed = FLF_Find_Spammers::list();
		...
		// Get a true/falsy
		$is_spammer = FLF_Find_Spammers::is_spammer( $form['comment_author_email'] );
		if ( $is_spammer ) {
			return true;
		}
